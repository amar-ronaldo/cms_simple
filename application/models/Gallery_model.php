...
class Gallery_model extends CI_Model{
	...
	var $table 		= 'ref_gallery';
	var $tableAs 	= 'ref_gallery a';
	...
	function records($where=array(),$isTotal=0){
		...
		$this->db->select("a.*,b.name as gallery_category,b.uri_path as uri_path_category,c.name as status,d.fullname as writer,e.name as language");
		$this->db->join('ref_gallery_category b','b.id=a.id_ref_gallery_category','left');
