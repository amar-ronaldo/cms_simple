...
function imagemanager($field = 'img', $img = '', $max_width_cropzoom = 277, $max_height_cropzoom = 150, $id = '', $is_edit = FALSE, $imgname = '', $idTitle = '', $path = '')
{

	$CI = &get_instance();
	$path            = ($field['path']) ? $field['path'] : 'images/article/small/';
	$category_images = ($field['category_images']) ? $field['category_images'] : 'img';
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="row" style="width:100%;">
						...
						<div class="col-lg-3 col-sm-3 col-3">
							<a class="btn btn-add" id="upload-img">Upload</a>
						</div>
					</div>
				</div> 
			</div>
	...
	<div class="modal modal-color-scheme fade invis" id="popImageManagerDetail" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header text-inverse">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close close-crop" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-body">
					...
					<a id="crop" class="btn btn-add">Create Thumbnail</a>
				</div>
				<div class="modal-footer">
					<a id="imagemanager-cancel" class="btn btn-warning"> Cancel </a>
					<a class="btn btn-add" id="imagemanager-save" data-path="' . $path . '" data-category="' . $category_images . '"> Save </a>
...
';
	...
	if ($field != 'img') {
		$html['browse'] = '<div class="browse-image" id="' . $field['id'] . '" data-category="' . $category_images . '">
		...
		$html['browse'] = '<div class="browse-image" id="' . $field . $id . '" data-category="">
					<img src="' . $img . '" width="100%">
					<div>Select Image</div>
					<i class="fa fa-file-picture-o" style="font-size: 60px;"></i>
				</div>
