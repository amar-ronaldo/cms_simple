...
-- Dumping data for table cms_deptech.access_log: ~48 rows (approximately)
...
-- Dumping data for table cms_deptech.file_manager: ~3 rows (approximately)
...
-- Dumping data for table cms_deptech.frontend_menu: ~0 rows (approximately)
...
-- Dumping data for table cms_deptech.login_transaction: ~8 rows (approximately)
...
INSERT INTO `login_transaction` (`id`, `id_ref_auth_user`, `ip_address`, `user_agent`, `create_date`, `last_activity`, `id_ref_active`, `lock_date`) VALUES
	...
	(4, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36', '2019-04-18 18:12:55', '2019-04-18 18:12:55', 1, '0000-00-00 00:00:00'),
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `page_content` varchar(255) DEFAULT NULL COMMENT 'Halaman Konten',
...
-- Dumping data for table cms_deptech.pages: ~0 rows (approximately)
...
-- Dumping data for table cms_deptech.ref_auth_pages: ~150 rows (approximately)
...
INSERT INTO `ref_language` (`id`, `name`, `code`, `status_lang`, `id_ref_delete`, `id_ref_auth_user_create`, `create_date`, `id_ref_auth_user_modify`, `modify_date`) VALUES
	...
	(2, 'English', 'EN', 0, 0, 1, '2018-12-10 11:07:00', 0, NULL);
...
-- Dumping data for table cms_deptech.ref_menu_admin: ~30 rows (approximately)
...
INSERT INTO `ref_menu_admin` (`id`, `id_ref_menu_admin_parents`, `menu`, `controller`, `urut`, `img_icon`, `breadcrumb`, `id_ref_delete`, `create_date`, `id_ref_auth_user_create`, `modify_date`, `id_ref_auth_user_modify`) VALUES
	...
	(21, 19, 'News Tags', 'news_tags', 3, '#', 'News Tags', 0, '2018-12-04 10:32:52', 1, '2018-12-04 10:36:51', 1),
	...
	(27, 19, 'All Tags', 'tags', 5, '#', 'All Tags', 0, '2018-12-06 19:07:57', 1, NULL, NULL),
	(28, 0, 'Master', '#', 9, 'list-icon feather feather-grid', 'Master', 0, '2018-12-07 10:40:11', 1, '2018-12-07 10:40:57', 1),
...
CREATE TABLE IF NOT EXISTS `ref_news` (
  ...
  KEY `is_delete` (`id_ref_delete`),
  KEY `id_language` (`id_ref_language`),
  CONSTRAINT `news_ufbk1` FOREIGN KEY (`id_ref_news_category`) REFERENCES `ref_news_category` (`id`),
  CONSTRAINT `news_ufbk2` FOREIGN KEY (`id_ref_status_publish`) REFERENCES `ref_status_publish` (`id`),
...
-- Dumping data for table cms_deptech.ref_news: ~0 rows (approximately)
...
-- Dumping data for table cms_deptech.ref_news_category: ~0 rows (approximately)
